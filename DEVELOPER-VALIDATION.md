# Development by Intent — Developer Validation v0.1

The purpose of this phase is to test whether independent developers can quickly understand Development by Intent well enough to try it and criticize it.
...
- experienced conventional developers;
- developers already using coding agents heavily;
- at least one developer skeptical of AI-first development;
- if practical, developers from more than one language or application domain.

The sample is exploratory, not statistically representative.
...
After the developer has spent roughly 10–15 minutes with the material, ask:

1. **In your own words, what is Development by Intent?**
2. **Does it differ meaningfully from ordinary AI-assisted coding or vibe coding? Why or why not?**
3. **Could you reproduce the Amazing Birthday development loop from the material provided?**
4. **Where do you think this approach will fail or become unsafe?**
5. **Would you try it on one small application of your own? If yes, what kind? If no, what blocks you?**

Do not defend DbI while collecting the first answer. Record the misunderstanding or objection as evidence.

## Highest-value outcome

The highest-value response is not necessarily enthusiasm.

Useful evidence includes:

- a developer accurately restating the method;
- a developer identifying a distinction we explained poorly;
- a credible claim that DbI is merely a renamed existing practice;
- inability to reproduce the tutorial;
- a concrete application class where the method fails;
...
- the tutorial is reproducible without private explanation;
...
If developers understand it and begin independent experiments, prioritize their evidence over additional internally generated examples.
