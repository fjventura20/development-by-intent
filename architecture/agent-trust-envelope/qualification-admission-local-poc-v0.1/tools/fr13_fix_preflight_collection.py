...
elif native_anchor in s:
    # PF10..PF14 has been migrated to native checks (per inbound
    # 20260917T180300Z-ate-fr13-native-preflight-fix-001). The subprocess
    # approach is obsolete; this tool has no further work to do.
    print("FR-13 PF10..PF14 already in native form; this tool is no-op on native (skipping)")
